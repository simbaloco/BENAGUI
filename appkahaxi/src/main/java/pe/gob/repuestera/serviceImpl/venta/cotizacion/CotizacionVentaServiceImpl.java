package pe.gob.repuestera.serviceImpl.venta.cotizacion;
...
public class CotizacionVentaServiceImpl implements CotizacionVentaService{
	...
	public void anularCotizacionVenta(VentaCabModel ventaCabModel, String usuario) throws Exception {
        ...
        cotizacionVentaMapper.anularCotizacionVenta(params);

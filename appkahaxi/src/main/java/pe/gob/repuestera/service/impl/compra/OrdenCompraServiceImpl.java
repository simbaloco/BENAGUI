package pe.gob.repuestera.service.impl.compra;
...
import pe.gob.repuestera.repository.compra.OrdenCompraMapper;
...
public class OrdenCompraServiceImpl implements OrdenCompraService {
	...
	public String registrarOrdenCompra(CompraCabModel compraCabModel, String usuario) throws Exception {
		...
		params.put(Constante.PARAM_SP_COD_CLIENTE, compraCabModel.getCodigoCliente());
